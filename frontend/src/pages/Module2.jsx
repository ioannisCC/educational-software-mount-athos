...
const Module2 = ({ user }) => {
  ...
  return (
    <div className="module-redesign" style={{ height: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* COMPACT HEADER */}
      <div className="module-header bg-success text-white p-3 shadow-sm">
        <div className="container-fluid">
          <div className="row align-items-center">
            <div className="col-md-8">
              <div className="d-flex align-items-center gap-3">
                <h4 className="mb-0">🏛️ Module 2: Monasteries & Architecture</h4>
                  ...
                  filteredContent.map(item => (
                    <div
                      ...
                      className={`content-item p-3 border-bottom cursor-pointer hover-bg-light ${
                        activeContent?._id === item._id ? 'bg-success text-white' : ''
                      }`}
                  ...
                  filteredQuizzes.map(quiz => (
                    <div
                      ...
                      className={`quiz-item p-3 border-bottom cursor-pointer hover-bg-light ${
                        activeQuiz?._id === quiz._id ? 'bg-success text-white' : ''
                      }`}
          ...
          <div className="content-display flex-grow-1 overflow-auto p-3">
            ...
            {!activeContent && !activeQuiz && (
              <div className="welcome-screen text-center py-5">
                <div className="mb-4">
                  <h2 className="text-success mb-3">🏛️ Welcome to Module 2: Monasteries & Architecture</h2>
                ...
                <div className="mb-4">
                  <h6>🏛️ What You'll Learn:</h6>
                  <div className="row">
                    <div className="col-md-6">
                      <ul className="list-unstyled text-start">
                        <li className="mb-2">🏰 The 20 ruling monasteries hierarchy</li>
                        <li className="mb-2">🌍 International Orthodox communities</li>
                        <li className="mb-2">🏗️ Byzantine fortress architecture</li>
                      </ul>
                    </div>
                    <div className="col-md-6">
                      <ul className="list-unstyled text-start">
                        <li className="mb-2">⛪ Sacred katholikon churches</li>
                        <li className="mb-2">🎨 Iconostasis and religious art</li>
                        <li className="mb-2">🏘️ Monastic living arrangements</li>
                      </ul>
                    </div>
                  </div>
                </div>
